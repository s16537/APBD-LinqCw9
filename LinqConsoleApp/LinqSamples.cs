        ...
        */
        ...
        public void Przyklad10()
        {
            ...
            var res2 = from emp in Emps
                       where emp.Ename == "Brak wartości" && emp.Job == null && emp.HireDate == null
                       select new { emp.Ename, emp.Job, emp.HireDate };
            var final = res.Union(res2);
        }
        ...
        public void Przyklad11()
        {
            var res = Emps.Select(emp => emp.Salary)
                          .Aggregate((res, next) => Math.Max(res, next));
            var emp = Emps.Single(emp => emp.Salary == res);
        }
        ...
        {
            var res = Emps.SelectMany(e => Depts, (e, dep) => new
            {
                Emp = e,
                Dept = dep.Deptno
            });
